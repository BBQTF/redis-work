...
public class RedisWorkApplicationTests {
    @Autowired
    ...
    public void test1() {
        ...
        DefaultTypedTuple<String> tuple2 = new DefaultTypedTuple<String>("p2", 4.1);
    ...
    public void test5() {
        ...
        Set<ZSetOperations.TypedTuple<String>> tuples = redisTemplate.opsForZSet().rangeWithScores("uniTop", 0, -1);
    ...
    @Test
    public void test11() {
        Object object = redisTemplate.opsForValue().get("ui");
